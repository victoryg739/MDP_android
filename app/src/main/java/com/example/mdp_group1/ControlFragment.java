...
public class ControlFragment extends Fragment {
    ...
    // Control Button
    ImageButton moveForwardImageBtn, turnUpRightImageBtn, moveBackImageBtn, turnUpLeftImageBtn, turnDownLeftImageBtn, turnDownRightImageBtn;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        turnUpRightImageBtn = MainActivity.getUpRightBtn();
        moveBackImageBtn = MainActivity.getDownBtn();
        turnUpLeftImageBtn = MainActivity.getUpLeftBtn();
        turnDownLeftImageBtn = MainActivity.getDownLeftBtn();
        turnDownRightImageBtn = MainActivity.getDownRightBtn();
        ...
        moveForwardImageBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (gridMap.getCanDrawRobot()) {
                    ...
                    MainActivity.printMessage("nw020");
        ...
        turnUpRightImageBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (gridMap.getCanDrawRobot()) {
                   ...
                   // MainActivity.printMessage("STM|Right");
                    MainActivity.printMessage("ne020");
        ...
        turnDownRightImageBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showLog("Clicked turnRightImageBtn");
                if (gridMap.getCanDrawRobot()) {
                    ...
                    MainActivity.refreshLabel();
                    // MainActivity.printMessage("STM|Right");
                    MainActivity.printMessage("nc020");
...
//                    MainActivity.printMessage("STM|Back");
                    MainActivity.printMessage("nx020");
                }
                else
                    updateStatus("Please press 'STARTING POINT'");
        ...
        turnUpLeftImageBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (gridMap.getCanDrawRobot()) {
                    ...
                    MainActivity.printMessage("nq020");
        ...
        turnDownLeftImageBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showLog("Clicked turnLeftImageBtn");
                if (gridMap.getCanDrawRobot()) {
                    ...
                    updateStatus("turning left");
                    //MainActivity.printMessage("STM|Left");
                    MainActivity.printMessage("nz020");
